...
function preload(){
    ...
    fallingImg = loadImage("images/baby falling/1.png"," images/baby falling/2.png " ,"images/baby falling/3.png ","images/baby falling/4.png","images/baby falling/5.png"," images/baby falling/6.png");
    stone = loadImage("images/in Game/stone.png")
}
function setup(){
...
function draw(){
    ...
    if (test.x >= 1200){
        ...
        stoneS = createSprite(885,180,10,10);
        stoneS.addImage(stone);
        stoneS.scale = 0.1;        
        BabyMoving();

        if(babyMoves.x === 900){
            babyMoves.velocityX = 0;
            babyFalling = createSprite(150,420,50,50);
            babyFalling.addImage(fallingImg);
            babyFalling.scale = 0.2;
            console.log("fallingImg");
        }


        input = createInput(" Enter value ");
